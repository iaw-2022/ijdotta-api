...
var ajv = new ajv_1.default({ removeAdditional: true, useDefaults: true });
/**
...
var Validator = /** @class */ (function () {
    ...
    function Validator() {
        ...
        var validationJSONS = __assign({}, validations);
        var schemaJSON = {};
        Object.keys(validations).forEach(function (validation) {
            schemaJSON = validationJSONS[validation];
            _this._schemaValidators[validation] = ajv.compile(schemaJSON);
        });
    }
    /**
    ...
    Validator.prototype.validate = function (data, schema) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                validationFunction = this._schemaValidators[schema];
                isValid = validationFunction(data);
                if (!isValid) {
                    throw new errors_1.CodedError('API_INVALID_PARAMS', 400, "The given parameters are not valid.");
                }
